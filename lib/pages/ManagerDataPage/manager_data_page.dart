...
class ManagerDataPageState extends ChangeNotifier {
  ...
  Future<void> updateCommission (BuildContext context, String newCommission) async {
...
class ManagerDataPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider( create: (context) => ManagerDataPageState(manager),
      child: Consumer<ManagerDataPageState>(
        builder: (_,state,__) {
          return Scaffold(
